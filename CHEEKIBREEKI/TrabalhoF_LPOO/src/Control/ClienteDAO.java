...
public class ClienteDAO {
    ...
    private final String stmtDeletarTodosPedidos = "DELETE FROM pedido WHERE cpf = ?;";
    ...
    public void excluiCliente(Cliente cliente) {
        ...
        try {
            connection = new ConnectionFactory().getConnection();
            stmt2 = connection.prepareStatement(stmtDeletarTodosPedidos);
            stmt2.setInt(1, cliente.getCpf());
            stmt2.execute();
        } catch (SQLException e) {
            throw new RuntimeException(e);
        } finally {
