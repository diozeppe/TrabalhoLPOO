...
public class TelaCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        boxAtualizarMaterial = new javax.swing.JComboBox<>();
        jLabel9 = new javax.swing.JLabel();
        jLabel10 = new javax.swing.JLabel();
        campoPrecoM2 = new javax.swing.JTextField();
        btnAtualizarPrecoMaterial = new javax.swing.JButton();
                    ...
                    .addGroup(abaPedidoLayout.createSequentialGroup()
                        ...
                        .addGroup(abaPedidoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(abaPedidoLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(totalPedido, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE)))
            ...
            .addGroup(abaPedidoLayout.createSequentialGroup()
                ...
                .addGroup(abaPedidoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(abaPedidoLayout.createSequentialGroup()
                        ...
                        .addGroup(abaPedidoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel12)
                            .addComponent(totalPedido, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(96, 96, 96)
        ...
        boxAtualizarMaterial.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Comum", "Refinado", "Deluxe" }));

        jLabel9.setText("Material:");

        jLabel10.setText("Preço do m2:");

        campoPrecoM2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                campoPrecoM2ActionPerformed(evt);
            }
        });

        btnAtualizarPrecoMaterial.setText("Atualizar");
        btnAtualizarPrecoMaterial.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAtualizarPrecoMaterialActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnAtualizarPrecoMaterial)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(boxAtualizarMaterial, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(campoPrecoM2))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(boxAtualizarMaterial, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel9))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel10)
        ...
        jTabbedPane1.addTab("Atualizar Preços", jPanel1);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            PedidoDAO dao = new PedidoDAO();
            double somaValores = dao.somarPedidos(Integer.parseInt(campoCpfPedido.getText()));
            totalPedido.setText(Double.toString(somaValores));
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null,"Erro ao conectar com o banco de dados.", "Erro", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private Double calcularCusto(){
        ...
        double precoMaterialComum = daoMaterial.getPreco(1);
        double precoMaterialRefinado = daoMaterial.getPreco(2);
        double precoMaterialDeluxe = daoMaterial.getPreco(3);
        String tipoForma = (boxForma.getSelectedItem()).toString();
        ...
        if((campoAltura.getText().isEmpty()) && (campoLargura.getText().isEmpty())){
            ...
            if(tipoMaterial.equals("Comum")){
                custo = areaM2 * precoMaterialComum;
                return custo;
            }
            else if(tipoMaterial.equals("Refinado")){
                custo = areaM2 * precoMaterialRefinado;
                return custo;
            }
            else{
                custo = areaM2 * precoMaterialDeluxe;
                return custo;
            }
        }else if(tipoForma.equals("Triangulo")){
            if(tipoMaterial.equals("Comum")){
        ...
        if(tipoForma.equals("Retangulo")){
            ...
            if(tipoMaterial.equals("Comum")){
                custo = novoRetangulo.area() * precoMaterialComum;
                return custo;
            }
            else if(tipoMaterial.equals("Refinado")){
                custo = novoRetangulo.area() * precoMaterialRefinado;
                return custo;
            }
            else{
                custo = novoRetangulo.area() * precoMaterialDeluxe;
                return custo;
            }
        }else if(tipoForma.equals("Triangulo")){
            Triangulo novoTriangulo = new Triangulo(largura,altura);
            if(tipoMaterial.equals("Comum")){
                custo = novoTriangulo.area() * precoMaterialComum;
                return custo;
            }
            else if(tipoMaterial.equals("Refinado")){
                custo = novoTriangulo.area() * precoMaterialRefinado;
                return custo;
            }
            else{
                custo = novoTriangulo.area() * precoMaterialDeluxe;
                return custo;
            }
        }else{
            Circulo novoCirculo = new Circulo(altura);
            if(tipoMaterial.equals("Comum")){
                custo = novoCirculo.area() * precoMaterialComum;
                return custo;
            }
            else if(tipoMaterial.equals("Refinado")){
                custo = novoCirculo.area() * precoMaterialRefinado;
                return custo;
            }
            else{
                custo = novoCirculo.area() * precoMaterialDeluxe;
                return custo;
            }
        }
        }
    ...
    private void btnAtualizarPrecoMaterialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarPrecoMaterialActionPerformed
        // TODO add your handling code here:
        double novoPreco = Double.parseDouble(campoPrecoM2.getText());
        MaterialDAO materialdao = new MaterialDAO();
        String material = boxAtualizarMaterial.getSelectedItem().toString();
        if(material.equals("Comum")){
            materialdao.atualizaPreco(1, novoPreco);
            campoPrecoM2.setText(Double.toString(novoPreco));
        }
        else if(material.equals("Refinado")){
            materialdao.atualizaPreco(2, novoPreco);
            campoPrecoM2.setText(Double.toString(novoPreco));
        }
        else{
            materialdao.atualizaPreco(3, novoPreco);
            campoPrecoM2.setText(Double.toString(novoPreco));
        }
        JOptionPane.showMessageDialog(null,"Valor atualizado.", "Sucesso!", JOptionPane.WARNING_MESSAGE);
        
    }//GEN-LAST:event_btnAtualizarPrecoMaterialActionPerformed

    private void campoPrecoM2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_campoPrecoM2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_campoPrecoM2ActionPerformed
    ...
    private javax.swing.JComboBox<String> boxAtualizarMaterial;
    ...
    private javax.swing.JButton btnAtualizarPrecoMaterial;
